...
void main() {
    ...
    if (is_left_boundary) {
        div_buffer.div[cell] = div_buffer.div[cell_r];
    } else if (is_right_boundary) {
		div_buffer.div[cell] = div_buffer.div[cell_l];
    }
    if (is_top_boundary) {
        div_buffer.div[cell] = div_buffer.div[cell_d];
    } else if (is_bottom_boundary) {
        div_buffer.div[cell] = div_buffer.div[cell_u];
    }
    ...
    if (is_left_boundary && is_top_boundary) {
        div_buffer.div[cell] = div_buffer.div[cell_dr]; 
    } else if (is_left_boundary && is_bottom_boundary) {
        div_buffer.div[cell] = div_buffer.div[cell_ur]; 
    } else if (is_right_boundary && is_top_boundary) {
        div_buffer.div[cell] = div_buffer.div[cell_dl]; 
    } else if (is_right_boundary && is_bottom_boundary) {
        div_buffer.div[cell] = div_buffer.div[cell_ul];
    }
}